...
from src.bg_tasks.redis_monitor import redis_memory_monitor
...
class RedisClient:
    ...
    def __init__(self):
        ...
        # print(f"[REDIS INIT] Redis caching enabled: {self.enabled}")
    ...
    async def connect(self):
        ...
        try:
            ...
            # print(f"[REDIS] Connected to Redis at {settings.REDIS_URL}")
